...
;----------------------------
global nMax_Level 				:= 250	;sets the level that the script will run to for each iteration
...
global gFormation_M 			:= "E"	;Values: Q/W/E sets which formation to use when Mirt is Active Patron 	(if changing use capital letters)
global gFormation_V 			:= "E"	;Values: Q/W/E sets which formation to use when Vajra is Active Active 	(if changing use capital letters)
...
global gStopChampLeveling		:= 18	;script will stop leveling Champs after this Zone: -1 is always, 13 is default
global gStopClickLeveling		:= 2	;script will stop leveling Click Damage after this Zone: -1 forever, 101 defualt
global gAllowF12_Leveling 		:= 1	;Values: 1 or 0 <-- default 1	
;----------------------
...
;----------------------------
;celleste, walnt and binwin
global Champ1	:= "10|-1|10"	;level up slot 1 (deekin) 9 times for No Patron and Vajra (wont do early leveling of Bruenor when on Mirt)
global Champ2	:= -1
global Champ3	:= -1
global Champ4	:= 18			;level up slot 4 (sentry) 17 times for All Runs (for higher favor amounts)	 
global Champ5	:= -1			;briv7 or dhadius6 trying to get the ult
global Champ6	:= 16			;level up slot 6 (shandie) 18 times for All Runs (for higher favor amounts)	
global Champ7	:= "4|4|4"		;level up slot 7 (minsc) 4 times and (black viper) 10 times
global Champ8	:= -1
global Champ9	:= -1
global Champ10	:= "14|14|-1"	;level up slot 10 (havilar)
global Champ11	:= -1
global Champ12	:= -1
...
;Speed champs only
;----------------------------
global Champ1_SpecialOptionQ 	:= 2			;deekin2
global Champ2_SpecialOptionQ 	:= -1			;celeste2-
global Champ3_SpecialOptionQ 	:= 1			;binwin1-
global Champ4_SpecialOptionQ 	:= 2			;sentry2
global Champ5_SpecialOptionQ 	:= -1			;briv3/dhadius2-
global Champ6_SpecialOptionQ 	:= 1			;shandie1
global Champ7_SpecialOptionQ 	:= 4			;minsc4, bv2
global Champ8_SpecialOptionQ 	:= -1			;walnut1-
global Champ9_SpecialOptionQ 	:= -1			;
global Champ10_SpecialOptionQ	:= 2			;havilar2
global Champ11_SpecialOptionQ 	:= -1			;
global Champ12_SpecialOptionQ 	:= -1			;
...
;----------------------------
;Champ Specialization selections will need to be set based on your formation
;one I use for challenges
;----------------------------
global Champ1_SpecialOptionE 	:= "2|-1|2"		;deekin2
global Champ2_SpecialOptionE 	:= -1			;
global Champ3_SpecialOptionE 	:= 1			;binwin1
global Champ4_SpecialOptionE 	:= 2			;sentry2
global Champ5_SpecialOptionE 	:= 1			;
global Champ6_SpecialOptionE 	:= 1			;shandie1
global Champ7_SpecialOptionE 	:= 4			;minsc4, bv2 (not vajra)
global Champ8_SpecialOptionE 	:= "1|-1|1"		;walnut1
global Champ9_SpecialOptionE 	:= -1			;
global Champ10_SpecialOptionE	:= "2|2|-1"		;havilar2
global Champ11_SpecialOptionE 	:= -1			;
global Champ12_SpecialOptionE 	:= 3			;zorbu3 (pointless)
...
;wait pixel for the response to a support ticket
global supportTicketX	:= 703
global supportTicketY	:= 456
global supportTicketCl	:= 0xDA0717		;redish
...
global reset_skip_x			:= 1135
global reset_skip_y			:= 680 
global reset_skip_c1		:= 0x469A26
